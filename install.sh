...
echo "   odbcpathway stream tcp nowait nobody ${LIBEXEC_DIR}/fbsd_exporter_server.sh fbsd_exporter_server.sh"
echo ""
echo "   Enable inetd in /etc/rc.conf:"
echo "   inetd_enable=\"YES\""
echo "   inetd_flags=\"-a X.X.X.X -wW -C 60\""
echo ""
echo "   Restart inetd:"
echo "   service inetd restart"
echo ""
echo "4. Test the setup:"
echo "   curl http://X.X.X.X:9628/metrics"
echo ""
echo "5. Configure Prometheus to scrape http://$(hostname):9628/metrics"
echo ""
